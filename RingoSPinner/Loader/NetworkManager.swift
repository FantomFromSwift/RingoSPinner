...
final class NetworkManager {
    ...
    private let installURL = "https://coolsterclickrho.click/v1/public/install" // ИЗМЕНИТЬ ДОМЕН
    private let refreshURL = "https://coolsterclickrho.click/v1/public/refresh" // ИЗМЕНИТЬ ДОМЕН
    ...
    func fetchInstallURL(bundle: String, fcmToken: String, device: String, appsFlyerId: String) async throws -> MainResponse {
        ...
        do {
            ...
            // 204 = сервер принял запрос, редиректа нет → идём на main
            if http.statusCode == 204 {
                print("✅ [InstallAPI] 204 No Content → main")
